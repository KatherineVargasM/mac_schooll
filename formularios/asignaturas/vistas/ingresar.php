...
<body>
    <form action="../php/controlador_insertar.php" method="post">
        <div>
            <h2 class="text-primary"> Nueva Asignatura</h2>
        </div>
        <div class="container">
            <div class="form-group row">
                <label class="col-2">Nombre</label>
                <input type="text" class="form-control col-4" name="txt_nombre" id="txt_nombre" maxlength="20" required>
            </div>
            <div class="form-group row">
                <label class="col-2">OBSERVACION</label>
                <input type="text" class="form-control col-4" name="txt_observacion" id="txt_observacion" maxlength="50">
            </div>
